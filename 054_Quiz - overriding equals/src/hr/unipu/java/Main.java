...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Question question1a =  new AShortAnswerQuestion("pitanje1", "o1");
        Question question1b =  new AShortAnswerQuestion("pitanje1", "o1");
        Question question2 =  new AMultipleChoiceQuestion("pitanje2", new String[]{"o1", "o2"});

        // Test jesu li pitanja ista?
        if (question1a.equals(question1b)) {
            System.out.println("Pitanja su jednaka.");
        } else {
            System.out.println("Pitanja su različita.");
        }
